...
public class Lua_UnityEngine_Shader : LuaObject {
	...
	static public int SetGlobalFloatArray_s(IntPtr l) {
		try {
			int argc = LuaDLL.lua_gettop(l);
			if(matchType(l,argc,1,typeof(int),typeof(System.Single[]))){
				System.Int32 a1;
				checkType(l,1,out a1);
				System.Single[] a2;
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_globalShaderHardwareTier(IntPtr l) {
		try {
			pushValue(l,true);
			pushEnum(l,(int)UnityEngine.Shader.globalShaderHardwareTier);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_globalShaderHardwareTier(IntPtr l) {
		try {
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,"globalShaderHardwareTier",get_globalShaderHardwareTier,set_globalShaderHardwareTier,false);
